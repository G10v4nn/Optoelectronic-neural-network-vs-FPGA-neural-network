...
HD_PWD='C:/Users/giova/Documents/Home/UNI/TESI/1_photontorch/2_fpga/test1/4x4NN/4x4NN.runs/design_2_axis_register_slice_0_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_axis_register_slice_0_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_axis_register_slice_0_7.tcl
